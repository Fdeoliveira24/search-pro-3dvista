...
function x(e) {
  var t = null,
    ...
    i = 1,
    o = null;
  if (f(e) || u(e)) (r = e), (t = L(e)), (n = S(e));
  else {
    if (!M.call(e, "name")) throw new Error(b("name"));
    var a = e.name;
    if (((r = a), M.call(e, "weight") && (i = e.weight) <= 0))
      throw new Error(k(a));
    (t = L(a)), (n = S(a)), (o = e.getFn);
  }
        ...
        (function e(t, i, o) {
          if (y(t))
            if (i[o]) {
              var a = t[i[o]];
              if (!y(a)) return;
              if (o === i.length - 1 && (f(a) || v(a) || g(a))) n.push(d(a));
              else if (u(a)) {
                r = !0;
...
var A = (function () {
  function e() {
    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
      ...
      o = t.fieldNormWeight,
      a = void 0 === o ? O.fieldNormWeight : o;
    r(this, e),
      (this.norm = (function () {
        var e =
        ...
        value: function (e, t) {
          ...
          this.keys.forEach(function (t, i) {
            ...
            if (y(o))
              if (u(o)) {
                for (
                  var a = [], c = [{ nestedArrIndex: -1, value: o }];
                  c.length;
...
function E(e, t) {
  var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
    ...
    o = n.fieldNormWeight,
    a = void 0 === o ? O.fieldNormWeight : o,
    c = new A({ getFn: i, fieldNormWeight: a });
  return c.setKeys(e.map(x)), c.setSources(t), c.create(), c;
}
function I(e) {
...
function C(e, t, n) {
  var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
    i = r.location,
    o = void 0 === i ? O.location : i,
    a = r.distance,
    c = void 0 === a ? O.distance : a,
    s = r.threshold,
    h = void 0 === s ? O.threshold : s,
    u = r.findAllMatches,
    l = void 0 === u ? O.findAllMatches : u,
    d = r.minMatchCharLength,
    f = void 0 === d ? O.minMatchCharLength : d,
    v = r.includeMatches,
    g = void 0 === v ? O.includeMatches : v,
    y = r.ignoreLocation,
    p = void 0 === y ? O.ignoreLocation : y;
  if (t.length > F)
    throw new Error("Pattern length exceeds max of ".concat(F, "."));
  for (
    var m,
      b = t.length,
      k = e.length,
      M = Math.max(0, Math.min(o, k)),
      w = h,
      x = M,
      L = f > 1 || g,
      S = L ? Array(k) : [];
    ...
    if (((w = Math.min(_, w)), (x = m + b), L))
      for (var j = 0; j < b; ) (S[m + j] = 1), (j += 1);
  }
  x = -1;
  for (var A = [], E = 1, C = b + k, N = 1 << (b - 1), P = 0; P < b; P += 1) {
    for (var W = 0, $ = C; W < $; ) {
      I(t, {
        errors: P,
        currentLocation: M + $,
    ...
    C = $;
    var D = Math.max(1, M - $ + 1),
      K = l ? k : Math.min(M + $, k) + b,
      z = Array(K + 2);
    z[K + 1] = (1 << P) - 1;
    for (var J = K; J >= D; J -= 1) {
      var R = J - 1,
  ...
  var U = { isMatch: x >= 0, score: Math.max(0.001, E) };
  if (L) {
    var B = (function () {
      for (
        var e =
    ...
    B.length ? g && (U.indices = B) : (U.isMatch = !1);
  }
  return U;
}
function N(e) {
...
var P = (function () {
    function e(t) {
      var n = this,
        ...
        o = i.location,
        a = void 0 === o ? O.location : o,
        c = i.threshold,
        s = void 0 === c ? O.threshold : c,
        h = i.distance,
        u = void 0 === h ? O.distance : h,
        l = i.includeMatches,
        d = void 0 === l ? O.includeMatches : l,
        f = i.findAllMatches,
        v = void 0 === f ? O.findAllMatches : f,
        g = i.minMatchCharLength,
        y = void 0 === g ? O.minMatchCharLength : g,
        p = i.isCaseSensitive,
        m = void 0 === p ? O.isCaseSensitive : p,
        b = i.ignoreLocation,
        k = void 0 === b ? O.ignoreLocation : b;
      if (
        (r(this, e),
        (this.options = {
          location: a,
        ...
        var M = function (e, t) {
            n.chunks.push({ pattern: e, alphabet: N(e), startIndex: t });
          },
          w = this.pattern.length;
        if (w > F) {
          for (var x = 0, L = w % F, S = w - L; x < S; )
            M(this.pattern.substr(x, F), x), (x += F);
          if (L) {
            var _ = w - F;
            M(this.pattern.substr(_), _);
          }
          ...
          value: function (e) {
            ...
            this.chunks.forEach(function (t) {
              var n = t.pattern,
                ...
                m = y.score,
                b = y.indices;
              p && (g = !0), (v += m), p && b && (f = [].concat(c(f), c(b)));
            });
  ...
  W = [];
function $(e, t) {
  for (var n = 0, r = W.length; n < r; n += 1) {
    var i = W[n];
...
var z = (function () {
  function e(n) {
    ...
    (this._keyStore = new w(this.options.keys)), this.setCollection(n, o);
  }
  return (
    o(e, [
      {
        key: "setCollection",
        value: function (e, t) {
          if (((this._docs = e), t && !(t instanceof A)))
      ...
      },
      {
        ...
        value: function (e) {
          ...
          return (
            ...
            })(h, this._docs, { includeMatches: i, includeScore: o })
          );
        },
      },
      {
        ...
        value: function (e) {
          ...
          if (u(n))
            ...
            var o = n.v,
              ...
              h = c.score,
              l = c.indices;
            s && i.push({ score: h, key: t, value: o, norm: a, indices: l });
          }
          return i;
        },
      },
...
(z.version = "7.0.0"),
  ...
  (z.parseIndex = function (e) {
    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
      ...
      i = t.fieldNormWeight,
      o = void 0 === i ? O.fieldNormWeight : i,
      a = e.keys,
      c = e.records,
      s = new A({ getFn: r, fieldNormWeight: o });
