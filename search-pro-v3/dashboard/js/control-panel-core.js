    ...
    // ==========================================
      ...
      thumbnailSettings: {
        ...
        defaultImages: {
          ...
          ProjectedImage:
            "assets/projected-image-default.jpg",
          ...
          "3DModelObject":
            "assets/3d-model-object-default.jpg",
...
businessData: {
  ...
  matchField: "id",
  businessDataUrl: `${window.location.origin}${window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/"))}/search-pro-v3/business-data/business.json`,
},
...
googleSheets: {
  ...
  localCSVUrl: `${window.location.origin}${window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/"))}/search-pro-v3/business-data/search-data.csv`,
  csvOptions: {
    header: true,
    skipEmptyLines: true,
    dynamicTyping: true,
