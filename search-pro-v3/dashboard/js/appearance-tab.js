    ...
    try {
      ...
      if (!typographySection) {
        ...
        if (altSection) {
          ...
          console.log("🎯 TYPOGRAPHY SETUP: No typography section found - skipping typography setup");
  ...
  applyColorLivePreview(fieldName, value) {
    try {
      ...
      if (cssVar) {
        ...
        console.warn(`🎨 No CSS variable mapping found for ${fieldName} (shortField: ${shortField})`);
      }
    } catch (error) {
