...
const l = (t) => `Missing ${t} property in key`,
  u = (t) => `Property 'weight' in key '${t}' must be a positive integer`,
...
function f(e) {
  let n = null,
    ...
    c = 1,
    o = null;
  if (s(e) || t(e)) (r = e), (n = p(e)), (i = m(e));
  else {
    if (!d.call(e, "name")) throw new Error(l("name"));
    const t = e.name;
    if (((r = t), d.call(e, "weight") && ((c = e.weight), c <= 0)))
      throw new Error(u(t));
    (n = p(t)), (i = m(t)), (o = e.getFn);
  }
  return { path: n, id: i, weight: c, src: r, getFn: o };
}
function p(e) {
      ...
      const l = (e, c, u) => {
        if (o(e))
          if (c[u]) {
            const d = e[c[u]];
            if (!o(d)) return;
            if (u === c.length - 1 && (s(d) || i(d) || r(d))) h.push(n(d));
            else if (t(d)) {
              a = !0;
              for (let t = 0, e = d.length; t < e; t += 1) l(d[t], c, u + 1);
            } else c.length && l(d, c, u + 1);
          } else h.push(e);
      };
      return l(e, s(c) ? c.split(".") : c, 0), a ? h : h[0];
    },
    ignoreLocation: !1,
    ignoreFieldNorm: !1,
    fieldNormWeight: 1,
  ...
  _addObject(e, n) {
    ...
    this.keys.forEach((n, r) => {
      ...
      if (o(c))
        if (t(c)) {
          let e = [];
          const n = [{ nestedArrIndex: -1, value: c }];
          for (; n.length; ) {
            const { nestedArrIndex: i, value: r } = n.pop();
            if (o(r))
              if (s(r) && !h(r)) {
...
function L(
  t,
  e,
  { getFn: n = M.getFn, fieldNormWeight: s = M.fieldNormWeight } = {},
) {
  const i = new y({ getFn: n, fieldNormWeight: s });
...
function v(
  ...
  for (let s = 0; s < l; s += 1) {
    ...
    for (; r < o; ) {
      k(e, {
        ...
        ? (r = o)
        : (v = o),
        (o = Math.floor((v - r) / 2 + r));
    }
    v = o;
    let h = Math.max(1, d - o + 1),
      M = c ? u : Math.min(d + o, u) + l,
      x = Array(M + 2);
    x[M + 1] = (1 << s) - 1;
    for (let r = M; r >= h; r -= 1) {
      let c = r - 1,
  ...
  const C = { isMatch: f >= 0, score: Math.max(0.001, L) };
  if (p) {
    const t = (function (t = [], e = M.minMatchCharLength) {
      ...
      for (let c = t.length; r < c; r += 1) {
        ...
        c && -1 === s
          ...
          : c ||
            -1 === s ||
            ((i = r - 1), i - s + 1 >= e && n.push([s, i]), (s = -1));
      }
      return t[r - 1] && r - s >= e && n.push([s, r - 1]), n;
    })(m, o);
    t.length ? h && (C.indices = t) : (C.isMatch = !1);
  }
  return C;
}
function S(t) {
...
class C {
  constructor(
    ...
    if (
      ...
      return;
    const a = (t, e) => {
        this.chunks.push({ pattern: t, alphabet: S(t), startIndex: e });
      },
...
const O = [];
function j(t, e) {
  for (let n = 0, s = O.length; n < s; n += 1) {
    let s = O[n];
...
const W = "$and",
  ...
  P = "$val",
  q = (t) => !(!t[W] && !t[z]),
  J = (t) => ({ [W]: Object.keys(t).map((e) => ({ [e]: t[e] })) });
function V(e, n, { auto: i = !0 } = {}) {
  const r = (e) => {
    let o = Object.keys(e);
    const h = ((t) => !!t[K])(e);
    if (!h && o.length > 1 && !q(e)) return r(J(e));
    if (((e) => !t(e) && c(e) && !q(e))(e)) {
      const t = h ? e[K] : o[0],
        r = h ? e[P] : e[t];
      if (!s(r)) throw new Error(((t) => `Invalid value for key ${t}`)(t));
      const c = { keyId: m(t), pattern: r };
      return i && (c.searcher = j(r, n)), c;
    }
...
class D {
  ...
  setCollection(t, e) {
    if (((this._docs = t), e && !(e instanceof y)))
      throw new Error("Incorrect 'index' type");
    this._myIndex =
      e ||
      L(this.options.keys, this._docs, {
    ...
    return (
      s.forEach(({ $: t, i: s }) => {
        if (o(t)) {
          let c = n(e, t, s);
          c.length &&
            (i[s] || ((i[s] = { idx: s, item: t, matches: [] }), r.push(i[s])),
            c.forEach(({ matches: t }) => {
              i[s].matches.push(...t);
            }));
        }
  ...
  _searchObjectList(t) {
    ...
    return (
      s.forEach(({ $: t, i: s }) => {
        ...
        let r = [];
        n.forEach((n, s) => {
          r.push(...this._findMatches({ key: n, value: t[s], searcher: e }));
        }),
  ...
  _findMatches({ key: e, value: n, searcher: s }) {
    ...
    if (t(n))
      n.forEach(({ v: t, i: n, n: r }) => {
        ...
        c &&
          i.push({ score: h, key: e, value: t, idx: n, norm: r, indices: a });
      });
    else {
      const { v: t, n: r } = n,
        { isMatch: c, score: o, indices: h } = s.searchIn(t);
      c && i.push({ score: o, key: e, value: t, norm: r, indices: h });
    }
    return i;
  }
}
