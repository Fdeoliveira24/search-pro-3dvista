      ...
      for (
        ...
        for (var W = 0, T = C; W < T; )
          I(t, {
            ...
            ? (W = T)
            : (C = T),
            (T = Math.floor((C - W) / 2 + W));
        C = T;
        var $ = Math.max(1, M - T + 1),
          D = l ? k : Math.min(M + T, k) + b,
          K = Array(D + 2);
        K[D + 1] = (1 << P) - 1;
        for (var z = D; z >= $; z -= 1) {
          var J = z - 1,
            ...
            value: function (e) {
              ...
              if (u(n))
                ...
                var o = n.v,
                  ...
                  l = c.indices;
                s &&
                  i.push({ score: h, key: t, value: o, norm: a, indices: l });
              }
              return i;
            },
          },
