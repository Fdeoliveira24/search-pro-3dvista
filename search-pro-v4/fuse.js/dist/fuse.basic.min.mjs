...
const a = (t) => `Missing ${t} property in key`,
  l = (t) => `Property 'weight' in key '${t}' must be a positive integer`,
...
function f(e) {
  let n = null,
    ...
    o = 1,
    c = null;
  if (i(e) || t(e)) (r = e), (n = g(e)), (s = p(e));
  else {
    if (!d.call(e, "name")) throw new Error(a("name"));
    const t = e.name;
    if (((r = t), d.call(e, "weight") && ((o = e.weight), o <= 0)))
      throw new Error(l(t));
    (n = g(t)), (s = p(t)), (c = e.getFn);
  }
  return { path: n, id: s, weight: o, src: r, getFn: c };
}
function g(e) {
      ...
      const l = (e, c, d) => {
        if (o(e))
          if (c[d]) {
            const u = e[c[d]];
            if (!o(u)) return;
            if (d === c.length - 1 && (i(u) || s(u) || r(u))) h.push(n(u));
            else if (t(u)) {
              a = !0;
              for (let t = 0, e = u.length; t < e; t += 1) l(u[t], c, d + 1);
            } else c.length && l(u, c, d + 1);
          } else h.push(e);
      };
      return l(e, i(c) ? c.split(".") : c, 0), a ? h : h[0];
    },
    ignoreLocation: !1,
    ignoreFieldNorm: !1,
    fieldNormWeight: 1,
...
class M {
  constructor({
    ...
    (this.norm = (function (t = 1, e = 3) {
      ...
      return {
        get(e) {
          const s = e.match(y).length;
          if (n.has(s)) return n.get(s);
          const r = 1 / Math.pow(s, 0.5 * t),
            o = parseFloat(Math.round(r * i) / i);
          return n.set(s, o), o;
        },
        clear() {
          n.clear();
  ...
  _addObject(e, n) {
    ...
    this.keys.forEach((n, r) => {
      let h = n.getFn ? n.getFn(e) : this.getFn(e, n.path);
      if (o(h))
        if (t(h)) {
          let e = [];
          const n = [{ nestedArrIndex: -1, value: h }];
          for (; n.length; ) {
            const { nestedArrIndex: s, value: r } = n.pop();
            if (o(r))
              if (i(r) && !c(r)) {
                let t = { v: r, i: s, n: this.norm.get(r) };
                e.push(t);
              } else
                t(r) &&
                  r.forEach((t, e) => {
...
function x(
  t,
  e,
  { getFn: n = m.getFn, fieldNormWeight: i = m.fieldNormWeight } = {},
) {
  const s = new M({ getFn: n, fieldNormWeight: i });
  return s.setKeys(t.map(f)), s.setSources(e), s.create(), s;
}
function L(
  t,
  {
...
function k(
  ...
  n,
  {
    ...
    includeMatches: h = m.includeMatches,
    ignoreLocation: a = m.ignoreLocation,
  } = {},
) {
  if (e.length > _) throw new Error(`Pattern length exceeds max of ${_}.`);
  const l = e.length,
    d = t.length,
  ...
  for (let i = 0; i < l; i += 1) {
    ...
    for (; r < c; ) {
      L(e, {
        ...
        ? (r = c)
        : (v = c),
        (c = Math.floor((v - r) / 2 + r));
    }
    v = c;
    let h = Math.max(1, u - c + 1),
      m = o ? d : Math.min(u + c, d) + l,
      M = Array(m + 2);
    M[m + 1] = (1 << i) - 1;
    for (let r = m; r >= h; r -= 1) {
      let o = r - 1,
  ...
  const I = { isMatch: g >= 0, score: Math.max(0.001, k) };
  if (p) {
    const t = (function (t = [], e = m.minMatchCharLength) {
      ...
      for (let o = t.length; r < o; r += 1) {
        ...
        o && -1 === i
          ...
          : o ||
            -1 === i ||
            ((s = r - 1), s - i + 1 >= e && n.push([i, s]), (i = -1));
      }
      return t[r - 1] && r - i >= e && n.push([i, r - 1]), n;
    })(y, c);
    t.length ? h && (I.indices = t) : (I.isMatch = !1);
  }
  return I;
}
function v(t) {
...
class w {
  constructor(
    ...
    if (
      ...
      return;
    const a = (t, e) => {
        this.chunks.push({ pattern: t, alphabet: v(t), startIndex: e });
      },
    ...
    if (l > _) {
      ...
      const e = l % _,
        n = l - e;
      for (; t < n; ) a(this.pattern.substr(t, _), t), (t += _);
      if (e) {
        const t = l - _;
...
const I = [];
function S(t, e) {
  for (let n = 0, i = I.length; n < i; n += 1) {
    let i = I[n];
  ...
  (e.matches = []),
    o(n) &&
      n.forEach((t) => {
        ...
        let s = { indices: n, value: i };
        t.key && (s.key = t.key.src),
          t.idx > -1 && (s.refIndex = t.idx),
          e.matches.push(s);
      });
}
function F(t, e) {
...
class A {
  constructor(t, e = {}, n) {
    if (((this.options = { ...m, ...e }), this.options.useExtendedSearch))
      throw new Error("Extended search is not available");
    (this._keyStore = new u(this.options.keys)), this.setCollection(t, n);
  }
  setCollection(t, e) {
  ...
  remove(t = () => !1) {
    ...
    for (let n = 0, i = this._docs.length; n < i; n += 1) {
      ...
      t(s, n) && (this.removeAt(n), (n -= 1), (i -= 1), e.push(s));
    }
    return e;
  }
  removeAt(t) {
  ...
  search(t, { limit: e = -1 } = {}) {
    ...
    return (
      (function (t, { ignoreFieldNorm: e = m.ignoreFieldNorm }) {
        t.forEach((t) => {
          let n = 1;
          t.matches.forEach(({ key: t, norm: i, score: s }) => {
  ...
  _searchStringList(t) {
    const e = S(t, this.options),
      { records: n } = this._myIndex,
      i = [];
    return (
      n.forEach(({ v: t, i: n, n: s }) => {
        if (!o(t)) return;
        ...
        r &&
          i.push({
            item: t,
            idx: n,
            matches: [{ score: c, value: t, norm: s, indices: h }],
          });
      }),
      i
    );
    ...
    return (
      i.forEach(({ $: t, i: i }) => {
        ...
        n.forEach((n, i) => {
          ...
          r.length && s.push({ idx: i, item: t, matches: r });
      }),
      s
    );
  }
  _findMatches({ key: e, value: n, searcher: i }) {
    if (!o(n)) return [];
    let s = [];
    if (t(n))
      n.forEach(({ v: t, i: n, n: r }) => {
        if (!o(t)) return;
        const { isMatch: c, score: h, indices: a } = i.searchIn(t);
        c &&
          s.push({ score: h, key: e, value: t, idx: n, norm: r, indices: a });
      });
    else {
      const { v: t, n: r } = n,
        { isMatch: o, score: c, indices: h } = i.searchIn(t);
      o && s.push({ score: c, key: e, value: t, norm: r, indices: h });
    }
    return s;
  }
}
(A.version = "7.0.0"),
  (A.createIndex = x),
  (A.parseIndex = function (
    t,
    { getFn: e = m.getFn, fieldNormWeight: n = m.fieldNormWeight } = {},
  ) {
    const { keys: i, records: s } = t,
      r = new M({ getFn: e, fieldNormWeight: n });
    return r.setKeys(i), r.setIndexRecords(s), r;
  }),
  (A.config = m);
export { A as default };
